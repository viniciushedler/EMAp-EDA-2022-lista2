...
\begin{figure}[!h]
  \centering
    \includegraphics[width=.3\textwidth]{figures/1_1.png}
    \includegraphics[width=.3\textwidth]{figures/1_2.png}
...
\begin{figure}[!h]
  \centering
    \includegraphics[width=.3\textwidth]{figures/2.png}
...
\begin{figure}[!h]
  \centering
    \includegraphics[width=.5\textwidth]{figures/3_1.png}
...
\begin{figure}[!h]
  \centering  
    \includegraphics[width=.4\textwidth]{figures/3_4.png}
